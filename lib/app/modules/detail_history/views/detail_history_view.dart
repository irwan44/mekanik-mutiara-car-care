                      ...
                      FutureBuilder<DetailHistory>(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            return Column(
                              children: [
                                for (var index = 0; index < (dataSvcDtlJasa?.length ?? 0); index++)
                                  Column(
                                    children: [
                                      Row(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              const Text('Harga :'),
                                              Text(
                                                'Rp. ${dataSvcDtlJasa?[index].hargaJasa}',
                                                style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                ),
                                              ),
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              const Text('Diskon :'),
                                              Text(
                                                'Rp. ${dataSvcDtlJasa?[index].diskonJasa}',
                                                style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                ),
                                              ),

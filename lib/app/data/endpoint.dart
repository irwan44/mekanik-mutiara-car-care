...
class API {
  static const _url = 'https://api.mutiaracarcare.com';
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['status'] == false) {
          ...
          if (obj.token != null) {
            ...
            final position = responseData['data']['karyawan']['posisi'];
            final role = positionRoleMap[position];
            if (role != null) {
              LocalStorages.setRole(role);
            }

            Get.snackbar('Selamat Datang', 'Mekanik Mutiara Car Care',
